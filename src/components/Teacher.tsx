...
const Teacher = () => {
  return (
    <div className="space-y-7 rounded-md border border-primary-light bg-white px-5 py-8 text-center md:flex md:space-y-0 md:p-10 md:text-left">
      ...
      <div className="md:max-w-120">
        ...
        <p className="text-neutral-500 text-sm">{m.teacher_desc()}</p>
      </div>
    </div>
  );
};
